...
*/
	...
	$settings = array(
					'free_video_time' => 'Free video time / day (<a href="http://avchat.net/integrations/wordpress" target="_blank">PRO</a>)',
					'drop_in_room' => 'Auto drop in room with id: (<a href="http://avchat.net/integrations/wordpress" target="_blank">PRO</a>)',
					'max_streams' => 'Max streams a user can watch',
					'max_rooms' => 'Max rooms a user can join',
					'username_prefix' => 'Auto add this prefix to username: (<a href="http://avchat.net/integrations/wordpress" target="_blank">PRO</a>)',
	);
	...
	$general_settings = array(
					...
					'display_mode' => 'Where the chat is placed (<a href="http://avchat.net/integrations/wordpress" target="_blank">PRO</a>)',
...
<form name="form1" method="post" action="<?php echo $location; ?>">
	<table style="text-align:center">
		...
		<tr>
			...
			?>
				<td style="padding:0 1px !important"><input type="text" 
					<?php 
