...
function avchat3_get_user_chat($content){
	...
	if($role != "visitors" && $_SESSION['can_access_chat'] != '1'){
		...
		$embed = '<input type="hidden" name="FB_appId" id="FB_appId" value="'.$FB_appId.'" /><input type="hidden" name="AVChat_exists" id="AVChat_exists" value="'.$AVChat_exists.'" /><script type="text/javascript" src="'.get_bloginfo('url').'/wp-content/plugins/avchat-3/tinycon.min.js"></script><script type="text/javascript" src="'.get_bloginfo('url').'/wp-content/plugins/avchat-3/facebook_integration.js"></script><script type="text/javascript" src="'.get_bloginfo('url').'/wp-content/plugins/avchat-3/swfobject.js"></script><script type="text/javascript" src="'.get_bloginfo('url').'/wp-content/plugins/avchat-3/new_message.js"></script><script type="text/javascript">var plugin_path = "'.get_bloginfo('url').'/wp-content/plugins/avchat-3/"; var embed = "'.$display_mode.'";</script><div id="myContent"><div id="av_message" style="color:#ff0000"> </div></div>';
		if($display_mode == 'embed'){
		$embed = $embed.'<script type="text/javascript">
				var flashvars = {
			...
			$chat_window = '&#39;'.get_bloginfo('url').'/wp-content/plugins/avchat-3/index_popup.php?movie_param='.$movie_param.'&FB_appId='.$FB_appId.'&#39;';
  			$page_content = "";
  			if($AVChat_exists == "true" ){
  				$page_content = '<script type="text/javascript">document.getElementById("av_message").innerHTML = \'<a style="display:block;padding:5px 3px;width:200px;margin:5px 0;text-align:center;background:#f3f3f3;border:1px solid #ccc" href="#" onclick="javascript:window.open('.$chat_window.')">Open chat in popup</a>\'</script>';
