...
The <a href='http://avchat.net/integrations/wordpress' title='AVChat plugin for Wordpress'>Audio-Video Chat Plugin for WordPress</a> handles the integration between AVChat and your WordPress web site.
...
For detailed information, see <a href='http://avchat.net/support/documentation/wordpress' title='Buy AVChat'>our detailed documentation</a>

== Frequently Asked Questions ==

= What do I need to use this plugin ? =

A WordPress web site and AVChat Software ( http://avchat.net/integrations/wordpress )
